...
/**
 * Title: 
 * Description: 起运港<StartPort>、起运国<StartCountry> 命名实体 特征提取
 ...
 */
public class CustomsNERInstanceForStartCountry extends NERInstance {

	public CustomsNERInstanceForStartCountry(String[] wordArray, String[] posArray, String[] nerArray, NERTagSet tagSet, FeatureMap featureMap) {
		super(wordArray, posArray, nerArray, tagSet, featureMap);
	}

	public CustomsNERInstanceForStartCountry(String[] wordArray, String[] posArray, FeatureMap featureMap) {
