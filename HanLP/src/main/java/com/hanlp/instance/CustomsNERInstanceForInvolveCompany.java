 ...
 * Author: 王杰
 * Create Time:2020/3/10 09:45
 */
public class CustomsNERInstanceForInvolveCompany extends NERInstance {
	public CustomsNERInstanceForInvolveCompany(String[] wordArray, String[] posArray, String[] nerArray, NERTagSet tagSet, FeatureMap featureMap) {
		super(wordArray, posArray, nerArray, tagSet, featureMap);
	}

	public CustomsNERInstanceForInvolveCompany(String[] wordArray, String[] posArray, FeatureMap featureMap) {
