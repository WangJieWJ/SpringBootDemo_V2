...
/**
 * Title: 
 * Description: 申报货物<DeclareGoods> 命名实体 特征提取
 * Copyright: 2020 北京拓尔思信息技术股份有限公司 版权所有.保留所有权
 * Company:北京拓尔思信息技术股份有限公司(TRS)
 * Project: SpringBootDemo
 * Author: 王杰
 * Create Time:2020/3/3 10:12
 */
public class CustomsNERInstanceForDeclareGoods extends NERInstance {

	public CustomsNERInstanceForDeclareGoods(String[] wordArray, String[] posArray, String[] nerArray, NERTagSet tagSet, FeatureMap featureMap) {
		super(wordArray, posArray, nerArray, tagSet, featureMap);
	}

	public CustomsNERInstanceForDeclareGoods(String[] wordArray, String[] posArray, FeatureMap featureMap) {
