 ...
 */
public class CustomsNERInstanceForInvolveUser extends NERInstance {
	public CustomsNERInstanceForInvolveUser(String[] wordArray, String[] posArray, String[] nerArray, NERTagSet tagSet, FeatureMap featureMap) {
		super(wordArray, posArray, nerArray, tagSet, featureMap);
	}

	public CustomsNERInstanceForInvolveUser(String[] wordArray, String[] posArray, FeatureMap featureMap) {
